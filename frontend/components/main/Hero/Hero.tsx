    ...
    <>
      <div className="backrnd-img relative p-0 m-0">
        ...
        <div className=" flex flex-col  gap-y-12 text-bc bg-none absolute top-[0%] xl:right-[50%] 2xl:right-[50%] xl:my-[11.25rem] my-[8.25rem] p-[1.25rem]">
          <h1 className="bg-none text-fontlight my-2  font-[Josefin Sans] text-5xl md:text-7xl lg:text-8xl font-style-normal font-medium">
          ...
          <Button
           ...
           text-fontlight shadow-lg rounded-2xl font-ClashGrotesk-Regular text-base"
          >
            Join Now
          </Button>
        </div>
